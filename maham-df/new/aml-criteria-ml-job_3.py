...
# c_s3_bucket_path = "s3://alm-platform-bucket/source/demo/output.cs

o_s3_bucket_path = s3_base_path +user_id+ "/"+date_path + "output.csv"
output_df.write.mode("overwrite").option("header", "true").csv(o_s3_bucket_path)